...
const AnimatedHeroSvgSideTukTuk = () => {
  ...
  return (
    <svg className="animated-hero-tuktuk" viewBox="0 0 257 520" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="tuktuk-container">
        ...
        <path d="M256.915 53.9468H86.3916V96.781H256.915V53.9468Z" fill="#FF9934"/>
        <path d="M256.914 0.0795898H182.043V42.9139H256.914V0.0795898Z" fill="#FFC801"/>
        <path d="M234.799 42.9136H204.142V54.1857H234.799V42.9136Z" fill="#FF9934"/>
        <path d="M256.914 273.72H76.8398L118.195 96.7812H256.914V273.72Z" fill="#FFC801"/>
        <path d="M256.914 250.817H99.4688L135.621 111.042H256.914V250.817Z" fill="#075A82"/>
        <path d="M256.914 273.72H76.8398L118.195 450.676H256.914V273.72Z" fill="#00B4D5"/>
        <path className="sm-wheel" d="M155.305 467.208H113.505V508.916H155.305V467.208Z" fill="#C93AC9"/>
        <path d="M256.914 450.676H76.8398V467.209H256.914V450.676Z" fill="#FFC801"/>
        <path className="light" d="M134.405 345.674C151.356 345.674 165.097 331.964 165.097 315.051C165.097 298.139 151.356 284.429 134.405 284.429C117.455 284.429 103.714 298.139 103.714 315.051C103.714 331.964 117.455 345.674 134.405 345.674Z" fill="#5F01D1"/>
